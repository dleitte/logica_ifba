...
int main()
{
    float valorProduto, valorEntrada;
    int valorPrestacao;
    
    printf("Insira o valor do produto: \n");
    scanf("%f", &valorProduto);
    
    valorPrestacao = valorProduto/3;
    valorEntrada = valorProduto - (valorPrestacao*2);
    
    printf("o valor da entrada = %f \n o valor das 2 prestacoes = %d", valorEntrada, valorPrestacao);
